		...
		<div>
			...
			<form name="registerform">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input id="hid" type="text" class="form-control" name="useruid" maxlength="20" autocomplete="off"
							value="" required="">
						<input type="text" class="form-control" id="dupl_check" placeholder="" value="">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input id="pwd" type="password" class="form-control" name="userpwd" maxlength="20" autocomplete="off"
							value="" required="">
					</div>
					<div class="col-sm-5">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input id="hname" type="text" class="form-control" name="userName" maxlength="20" autocomplete="off"
							value="" required="">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<textarea name="info" id="hostinfo" placeholder="간단한 업체 소개를 입력해 주세요" cols="30" rows="10"
							style="width: 98%;" maxlength="200" required=""></textarea><br />
					</div>
				</div>
