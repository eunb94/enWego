...
public class ReviewCrawling extends Proxy{
	...
	@Transactional
	public ArrayList<HashMap<String,String>> hotelCrawing(){
		//
		String url = "https://www.wego.co.kr/hotels/searches/SEL/2020-01-23/2020-01-28/1/2?guests=2&sort=popularity&order=desc&amenities=8";
		inventory.clear();
