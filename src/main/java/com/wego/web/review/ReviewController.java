...
public class ReviewController {
	...
	public Map<?,?> comment(@RequestBody Review param,@PathVariable String seq){
		HashMap<String,String> map = new HashMap<>();
		System.out.println("코멘트 컨트롤러"+seq);
		System.out.println("코멘트 컨트롤러"+param.getArtseq());
		Consumer<Review> c = s->reviewMapper.insertComment(param);
		c.accept(param);
